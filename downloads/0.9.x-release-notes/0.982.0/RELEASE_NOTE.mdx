...
<RawHtml html={"<p>Helm chart generation support</p>"} />

# Performance results

<RawHtml html={"<p>From this release onwards Ballerina <a href=\"https://github.com/ballerina-platform/ballerina-lang/blob/v0.982.0/performance/benchmarks/summary.md\">performace test results</a> will be available in the repository as a summary.</p>"} />

# Bug Fixes

<RawHtml html={"<p>Please refer <a href=\"https://github.com/ballerina-platform/ballerina-lang/issues?q=is%3Aissue+milestone%3A0.982.0+is%3Aclosed+label%3AType%2FBug\">Github milestone</a> to view bug fixes</p>"} />

# Getting Started

<RawHtml html={"<p>You can download the Ballerina distributions, try samples, and read the documentation at https://ballerina.io. You can also visit the [Quick Tour] (https://ballerina.io/learn/quick-tour/) to get started. We encourage you to report issues, improvements, and suggestions at the <a href=\"https://github.com/ballerina-platform/ballerina-lang\">Ballerina Github Repository</a>.</p>"} />
