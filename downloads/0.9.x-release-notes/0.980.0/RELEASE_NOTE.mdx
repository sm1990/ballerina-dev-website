...
<RawHtml html={"<p>Please refer <a href=\"https://github.com/ballerina-platform/ballerina-lang/issues?q=is%3Aissue+milestone%3A0.980.0+is%3Aclosed+label%3AType%2FBug\">Github milestone</a> to view bug fixes</p>"} />
...
<RawHtml html={"<p>Use of &ldquo;null&rdquo; value in a non-JSON related context is not restricted yet.</p>"} />

### Int

<RawHtml html={"<p>Binary and Octal literal support is available in Ballerina 0.980.0 and it is not part of the specification.</p>"} />

### Decimal

<RawHtml html={"<p>Type <code>decimal</code> is not supported yet.</p>"} />
...
<RawHtml html={"<p>Table type descriptor is not supported yet.</p>"} />

### Error

<RawHtml html={"<p>Error type is not supported yet. Instead the implementation uses a record based error type.</p>"} />
