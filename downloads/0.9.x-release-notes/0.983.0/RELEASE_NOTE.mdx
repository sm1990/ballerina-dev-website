...
<RawHtml html={"<p>From this release onwards, Composer is removed from the distribution. You can view and edit Ballerina programs visually using the VSCode plugin.</p>"} />
...
<RawHtml html={"<p>Please refer to <a href=\"https://github.com/ballerina-platform/ballerina-lang/blob/v0.983.0/performance/benchmarks/summary.md\">Ballerina performace test results</a> that is available in the repository.</p>"} />

# Bug Fixes

<RawHtml html={"<p>Please refer <a href=\"https://github.com/ballerina-platform/ballerina-lang/issues?q=is%3Aissue+milestone%3A0.983.0+is%3Aclosed+label%3AType%2FBug\">Github milestone issues</a> to view bug fixes.</p>"} />
