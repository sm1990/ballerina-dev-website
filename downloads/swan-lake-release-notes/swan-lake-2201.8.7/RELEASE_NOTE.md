...
description: Swan Lake Update 8 (2201.8.7) - Release note
slug: /swan-lake-release-notes/swan-lake-2201.8.7
---
...
Run the command below to update your current Ballerina installation directly to 2201.8.7 by using the [Ballerina Update Tool](https://ballerina.io/learn/update-tool/).
