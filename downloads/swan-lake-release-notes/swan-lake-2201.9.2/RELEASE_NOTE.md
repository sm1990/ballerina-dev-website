...
description: Swan Lake Update 9 (2201.9.2) - Release note
slug: /swan-lake-release-notes/swan-lake-2201.9.2
---
...
Run the command below to update your current Ballerina installation directly to 2201.9.2 by using the [Ballerina Update Tool](https://ballerina.io/learn/update-tool/).
