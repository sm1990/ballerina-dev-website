---
title: 1.2.9
description: 1.2.9 release notes
slug: /1.2.x-release-notes/1.2.9
---
...
You can use the [update tool](https://ballerina.io/learn/update-tool/) to update to jBallerina 1.2.9 as follows.
