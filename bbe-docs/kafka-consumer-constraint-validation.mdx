...
slug: "/kafka-consumer-constraint-validation/"
keywords:
  - "ballerina"
...
import ExampleComponent, {codeSnippetData} from '@site/src/generated/bbe/examples/kafka-consumer-constraint-validation/content';
