...
>**Info:** This **Visualize** CodeLens appears only for the entities defined in the model definition file inside the `persist` directory of your Ballerina project. For instructions on creating the data model definition, see [Model your data](https://ballerina.io/learn/manage-data-persistence-with-bal-persist/#model-your-data).
...
>**Info:** This button appears if you open the model definition file inside the `persist` directory of your Ballerina project. For instructions on creating the data model definition, see [Model your data](https://ballerina.io/learn/manage-data-persistence-with-bal-persist/#model-your-data).
