...
>**Tip:** Click the **Debug** CodeLens to debug the Ballerina program you ran. For more information, see [Debug the code](https://ballerina.io/learn/vs-code-extension/debug-the-code/debug-sessions/).
