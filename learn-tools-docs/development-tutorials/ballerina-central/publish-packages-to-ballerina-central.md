...
1. Create an account on Ballerina Central. To register, [visit the home page](https://central.ballerina.io/) and log in via a Google, GitHub, Microsoft, or email account.
