...
* For map literals, follow the same formatting guidelines as [Record literals](/learn/expressions/#record-literal).
...
* Follow the formatting guidelines of [Record literals](/learn/expressions/#record-literal) when formatting a table block.
