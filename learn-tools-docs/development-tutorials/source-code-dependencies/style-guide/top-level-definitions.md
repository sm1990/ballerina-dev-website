...
description: "The sections below include the coding conventions with respect to top-level definitions."
...
* When formatting service-level method definitions, block indent each element and
  follow the [Function definition](/learn/top-level-definitions/#function-definition) formatting guidelines.
...
* For method definitions in the class definition, follow the [Function definition](/learn/top-level-definitions/#function-definition) formatting guidelines.
