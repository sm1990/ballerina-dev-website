...
4. Configuration values for testing can be provided in a file named `Config.toml` located in the `tests` directory. For more details, see [Define test-specific configurations](https://ballerina.io/learn/test-ballerina-code/configure-tests/#define-test-specific-configurations).
...
Ballerina defines a specific TOML syntax based on the [TOML(v0.4) format](https://toml.io/en/v0.4.0) to be used when configuring the variables through the configuration files and environment variables. 
