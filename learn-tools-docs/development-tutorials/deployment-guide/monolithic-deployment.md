...
This guide explains how to deploy Ballerina services in a monolithic architecture, offering a traditional server-based approach without containerization. It covers two deployment strategies, centralized and decentralized.
...
5. Implement the business logic in the Ballerina package.
    ...
    > **Tip:**
    > - Utilize the [Ballerina HTTP default listener](pathname:///spec/http/spec.md#213-default-listener) to efficiently manage multiple HTTP services on a single port, reducing resource consumption.
