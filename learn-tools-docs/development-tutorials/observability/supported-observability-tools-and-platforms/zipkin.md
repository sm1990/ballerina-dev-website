...
>**Tip:** There are many possible ways to deploy Zipkin. For more information, see [Zipkin Quickstart](https://zipkin.io/pages/quickstart).
...
Go to [http://localhost:9411](http://localhost:9411) and load the web UI of Zipkin to make sure it is functioning properly. You can select the service for which you need tracing information find traces.
