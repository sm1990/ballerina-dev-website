...
Ballerina provides metrics compatible with [Prometheus](https://prometheus.io), which is widely used worldwide to monitor open-source systems.
...
>**Tip:** There are many other ways to install Prometheus and you can find possible options from the [installation guide](https://prometheus.io/docs/prometheus/latest/installation/).
> The easiest option is to use precompiled binaries listed in [Downloads](https://prometheus.io/download/).
...
Go to [http://localhost:19090/](http://localhost:19090/) and check whether you can see the Prometheus graph.
...
2. Go to [http://localhost:3000/](http://localhost:3000/) to access the Grafana dashboard running on Docker.
...
5. Import the Grafana dashboard designed to visualize Ballerina metrics from [https://grafana.com/dashboards/5841](https://grafana.com/dashboards/5841) as shown below.
