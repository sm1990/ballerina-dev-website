...
Send requests to [http://localhost:8090/shop](http://localhost:8090/shop).
...
Open the OpenSearch Dashboard in your browser at [http://localhost:5601](http://localhost:5601) and log in using the admin credentials you set up in the `.env` file.
