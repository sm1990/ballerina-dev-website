...
3. Execute `bal build --graalvm --cloud=docker` to generate the artifacts with the native executable. 
   ...
   >**Info:** Optionally, you can create a file named `Cloud.toml` in the package directory to add cloud related configurations. For more information, see [Docker](/learn/by-example/docker-hello-world/) and [Kubernetes](/learn/by-example/kubernetes-hello-world/) documentation.
