...
1. <a id="packWindows" href="https://dist.ballerina.io/downloads/2201.13.2/ballerina-2201.13.2-swan-lake.zip" class="cGTMDownload cDownload" data-download="downloads" data-pack="ballerina-2201.13.2-swan-lake.zip"> Download the Ballerina language ZIP file </a> and unzip it to a preferred location using an archiver tool of your choice. This creates a directory named `ballerina-<VERSION>` in your system.
...
For more information, see [Update Tool](https://ballerina.io/learn/update-tool/).
