...
This guide helps you understand the basics of using natural expressions in Ballerina to work with LLMs.
...
2. A text editor
  >**Tip:** Preferably, [Visual Studio Code](https://code.visualstudio.com/) with the 
  [Ballerina extension](https://wso2.com/ballerina/vscode/docs/) installed. Enable [experimental features](/learn/vs-code-extension/configure-the-extension/) for Ballerina.
