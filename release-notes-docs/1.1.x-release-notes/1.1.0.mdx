---
title: "1.1.0"
description: "1.1.0 release notes"
slug: "/1.1.x-release-notes/1.1.0"
---

import RawHtml from '@site/src/components/RawHtml';

<RawHtml html={"<p>Ballerina 1.1.0 is the year end release which has significant improvements to the developer tooling, standard\n    library modules, compiler, and runtime.</p>"} />
