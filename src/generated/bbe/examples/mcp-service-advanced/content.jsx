...
export default function McpServiceAdvanced({codeSnippets}) {
...
<p>The Model Context Protocol (MCP) is a standard for connecting AI applications to external data sources, tools, and workflows (prompts).</p>


<p>Ballerina’s MCP library allows you to create MCP servers that expose tools. A <code>mcp:AdvancedService</code> service expects two remote methods, namely <code>onListTools</code> and <code>onCallTool</code>, to allow AI assistants to discover and call tools respectively.</p>


<p>This example demonstrates how to create an MCP server that exposes weather-related tools via explicit MCP methods, allowing AI assistants to discover and use tools to retrieve current weather data and forecasts for different locations.</p>


<p>For more information on the underlying module, see the <a href="https://lib.ballerina.io/ballerina/mcp/latest/"><code>ballerina/mcp</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/mcp-service-advanced", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run mcp_service_advanced.bal`}</span>
</code></pre>
          </Col>
        </Row>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/ai-agent-mcp-integration/">The AI agents integrated with MCP servers example</a></span>
                        </li>
