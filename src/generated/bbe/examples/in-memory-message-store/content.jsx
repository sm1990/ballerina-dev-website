...
export const codeSnippetData = [`import ballerina/messaging;
...
export default function InMemoryMessageStore({codeSnippets}) {
...
<p>This example demonstrates how to use the built-in <code>InMemoryMessageStore</code> implementation provided by the <code>messaging</code> library. The <code>InMemoryMessageStore</code> is a ready-to-use implementation of the <code>messaging:Store</code> interface that’s ideal for quick testing and development scenarios where you don’t need persistence.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/in-memory-message-store", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run in_memory_message_store.bal`}</span>
<span>{`
`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/message-store-type/">Message store type</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://central.ballerina.io/ballerinax/rabbitmq/latest#MessageStore">RabbitMQ message store</a></span>
                        </li>
