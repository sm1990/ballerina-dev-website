...
export default function RegexpReplaceOperations({codeSnippets}) {
...
<p>The <code>RegExp</code> type supports a set of langlib functions to replace parts of strings that match specific patterns.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/regexp-replace-operations", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run regexp_replace_operations.bal`}</span>
<span>{`****-****-****-5432`}</span>
