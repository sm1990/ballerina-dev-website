...
export default function RegexpType({codeSnippets}) {
...
<p>A <code>RegExp</code> value can be created by using the regexp template expression or calling the <a href="https://lib.ballerina.io/ballerina/lang.regexp/latest#fromString"><code>fromString</code> method of the lang.regexp</a> module.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/regexp-type", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/regexp-operations-overview/">RegExp langlib functions overview</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
