...
export default function LoggerFromConfig({codeSnippets}) {
...
<p>This example demonstrates how to create specialized loggers with unique configurations. Each logger can have its own format, destinations, log level, file rotation policy, and default context.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/logger-from-config", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><strong>Audit logger</strong>: Uses SIZE_BASED rotation (10MB file size limit) with JSON format</span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><strong>Metrics logger</strong>: Uses TIME_BASED rotation (24-hour age limit) with LOGFMT format</span>
                        </li>
                    </ul>

<blockquote>
<p><strong>Note:</strong> All loggers created from the configuration automatically inherit the default context of the root logger.</p>
</blockquote>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run logger_from_config.bal`}</span>
<span>{`
`}</span>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref2}>
      <code className="d-flex flex-column"><span>{`{"time":"2026-01-05T21:22:17.164+05:30", "level":"INFO", "module":"", "message":"User action recorded", "action":"login", "userId":"alice123", "env":"prod", "nodeId":"server-001", "component":"audit", "compliance":"SOX"}`}</span>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref3}>
      <code className="d-flex flex-column"><span>{`time=2026-01-05T21:22:17.179+05:30 level=DEBUG module="" message="Recording performance metric" env="prod" nodeId="server-001" component="metrics" retention="30days" operation="performance_monitoring"`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://ballerina.io/spec/log/#432-loggers-with-unique-logging-configuration"><code>log</code> module - Specification</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
      ...
      <Link
        title="Custom logger"
        href="/learn/by-example/custom-logger/"
      >
