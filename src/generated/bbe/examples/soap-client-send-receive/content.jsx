...
export default function SoapClientSendReceive({codeSnippets}) {
...
<p>The <code>soap</code> module provides APIs to connect to a SOAP endpoint that supports SOAP 1.1 or 1.2 versions. Users can specify the version when importing the <code>soap</code> module. The <code>sendReceive()</code> API will send a request to a SOAP endpoint and bind the response to one of the <code>xml</code> or <code>mime:Entity[]</code> data types determined by the user. The <code>sendOnly()</code> API will fire and forget a SOAP request.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/soap-client-send-receive", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run soap_client_send_receive.bal`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/soap/#21-client"><code>soap</code> Client - Specification</a></span>
                        </li>
