...
export default function XmlToRecord({codeSnippets}) {
...
<p>The <code>data.xmldata</code> library provides multiple APIs to perform the conversion from XML source, which can be provided as a <code>string</code>, <code>byte array</code>, <code>byte block stream</code>, or <code>xml</code>, into a Ballerina record.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/xml-to-record", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run xml_to_record.bal`}</span>
