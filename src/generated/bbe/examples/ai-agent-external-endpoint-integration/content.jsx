...
export default function AiAgentExternalEndpointIntegration({codeSnippets}) {
...
<p>Ballerina enables developers to easily create intelligent AI agents powered by large language models (LLMs) and integrated with tools, including local tools, MCP tools, and external APIs. These AI agents can automate complex workflows, interact with users through natural language, and seamlessly connect with internal and external systems.</p>


<p>This example demonstrates how to create an AI agent that can access Gmail and Google Calendar by integrating with Google APIs as external endpoints. The agent functions as a personal assistant that can read emails, send emails, view calendar events, and create new calendar entries.</p>
...
<blockquote>
<p>Note: Follow the <a href="https://central.ballerina.io/ballerinax/googleapis.gmail/latest#setup-guide">connector setup guide</a> to obtain the connector configuration.</p>
</blockquote>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/ai-agent-external-endpoint-integration", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run ai_agent_external_endpoint_integration.bal`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/ai-agent-local-tools/">The Agent with local tools example</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/ai-agent-mcp-integration/">The Agent with MCP integration example</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/ai-agent-tool-kit/">The Agent with tool kits example</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
...
<ul style={{ marginLeft: "0px" 
      ...
      <Link
        title="Chat agents"
        href="/learn/by-example/chat-agents/"
      >
