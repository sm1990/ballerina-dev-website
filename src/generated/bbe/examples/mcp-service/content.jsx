...
export default function McpService({codeSnippets}) {
...
<p>Ballerina’s MCP library allows you to create MCP servers that expose tools. Remote methods of a <code>mcp:Service</code> service declaration automatically become MCP tools that AI assistants can discover and call.</p>


<p>This example demonstrates how to create an MCP server that exposes weather-related tools, allowing AI assistants to discover and use tools to retrieve current weather data and forecasts for different locations.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/mcp-service", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run mcp_service.bal`}</span>
</code></pre>
          </Col>
        </Row>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/ai-agent-mcp-integration/">AI agents integrated with MCP servers example</a></span>
                        </li>
