...
export default function TimeFormattingAndParsing({codeSnippets}) {
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/time-formatting-and-parsing", "_blank");
      }}
...
<span>{`Email string of the civil record: Wed, 10 Mar 2021 19:51:55 -0800`}</span>
      ...
      <Link
        title="Time Zone"
        href="/learn/by-example/time-zone/"
      >
