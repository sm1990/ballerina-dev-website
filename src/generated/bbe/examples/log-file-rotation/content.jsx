...
export default function LogFileRotation({codeSnippets}) {
...
<p>Log file rotation helps manage log file sizes by automatically creating backups when certain conditions are met, preventing disk space issues. This example demonstrates TIME_BASED rotation configured through <code>Config.toml</code>.</p>


<h2>Configuring File Rotation</h2>


<p>The root logger is configured in <code>Config.toml</code> with TIME_BASED rotation. All logs using the default logger will automatically benefit from this rotation policy.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/log-file-rotation", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run log_file_rotation.bal`}</span>
</code></pre>
          </Col>
        </Row>
...
<p>When a log file rotates, it’s renamed with a timestamp suffix and a new file is created:</p>


<pre style={{ marginLeft: "0px" }} 
    className="p-3 rounded bash"><code>logs/
  app.log                            (current log file)
  app-20251223-225602.log            (rotated backup)
  app-20251223-223015.log            (older backup)</code></pre>

<p>Older backups beyond <code>maxBackupFiles</code> are automatically deleted.</p>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref2}>
      <code className="d-flex flex-column"><span>{`\$ ls -la logs/`}</span>
<span>{`total 16`}</span>
...
<td>Rotation trigger: <code>&quot;SIZE_BASED&quot;</code>, <code>&quot;TIME_BASED&quot;</code>, or <code>&quot;BOTH&quot;</code></td>
</tr>
<tr>
...
<tr>
<td><code>maxBackupFiles</code></td>
<td>10</td>
...
<blockquote>
<p><strong>Note:</strong> This example uses a small threshold (5 seconds) to make rotation observable during demonstration. In production, use realistic values such as <code>maxAge = 86400</code> (24 hours).</p>
</blockquote>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://ballerina.io/spec/log/#35-configure-log-rotation"><code>log</code> module - Specification</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
