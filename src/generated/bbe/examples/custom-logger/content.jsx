...
export default function CustomLogger({codeSnippets}) {
...
<p>This example demonstrates how to implement custom loggers that conform to the <code>log:Logger</code> type. Custom loggers can automatically include specific context and provide specialized logging behavior for different components.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/custom-logger", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run custom_logger.bal`}</span>
<span>{`
`}</span>
...
<blockquote>
<p><strong>Note:</strong> In this example, the log module print methods are used to simulate the logging behaviour. So the root logger configurations will be applied to the log messages. But in a real world scenario, you would implement the actual logging logic inside the custom logger methods with custom log formats and destinations.</p>
</blockquote>


<p>The custom logger implementation allows for flexible and reusable logging strategies tailored to specific application needs.</p>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://ballerina.io/spec/log/#41-logger"><code>log</code> module - Specification</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
