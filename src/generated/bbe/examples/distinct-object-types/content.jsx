...
export default function DistinctObjectTypes({codeSnippets}) {
...
<p>For more explicit control over object type relations you can use <code>distinct</code> object types. Each distinct object type declaration has a unique type ID. When you include a distinct object type within another object type declaration, the new type’s type ID set will include the type IDs of the included type. When checking if a given object type <code>OSub</code> is a subtype of a distinct object type <code>OSuper</code> there is the additional requirement that the <code>OSub</code> type must contain all the type IDs of the <code>OSuper</code> type.</p>


<p>This way you can achieve the same behavior as a nominal type system within Ballerina’s structured type system, which is useful to support features such as GraphQL API interfaces.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/distinct-object-types", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://ballerina.io/learn/by-example/graphql-interfaces/">GraphQL service - Interfaces</a></span>
                        </li>
