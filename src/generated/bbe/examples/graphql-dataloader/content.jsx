...
export default function GraphqlDataloader({codeSnippets}) {
...
<p>The Ballerina GraphQL module provides the capability to batch and cache data fetching from data sources using the <code>graphql.dataloader</code> submodule. To leverage this functionality in a GraphQL service, you must register data loaders through the <code>graphql:Context</code> object and implement the corresponding prefetch method logic and resolver method logic.</p>


<p>A prefetch method, in the context of Ballerina GraphQL, is a method that is invoked before the actual resolver method. By default, the prefetch method name follows the convention of having the prefix <code>pre</code>, followed by the resolver method name. The use of <code>graphql.dataloader</code> avoids excessive data fetching, effectively addressing the GraphQL N+1 problem.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/graphql-dataloader", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run graphql_dataloader.bal`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/graphql.dataloader/latest"><code>garaphql.dataloader</code> module - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/graphql/#106-dataloader">DataLoader - Specification</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/graphql/#example-utilizing-multiple-dataloaders-in-a-graphql-service">Utilizing multiple dataloaders in a graphql service</a></span>
                        </li>
