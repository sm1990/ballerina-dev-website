...
export const codeSnippetData = [`import ballerinax/aws.lambda;
...
export default function AwsLambdaExecutionContext({codeSnippets}) {
...
<p>The example below demonstrates how the execution context information of an AWS function can be retrieved.</p>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal new aws_lambda_execution_context`}</span>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      className="bg-transparent border-0 m-0 p-2 ms-auto"
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/aws-lambda-execution-context", "_blank");
      }}
