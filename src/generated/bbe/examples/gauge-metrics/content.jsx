...
export default function GaugeMetrics({codeSnippets}) {
...
<p>Ballerina supports observability out of the box and metrics is one of the three key components of observability. To observe Ballerina code, the build time flag <code>--observability-included</code> should be given along with the <code>Config.toml</code> file when starting the service. The <code>Config.toml</code> file should contain the required runtime configurations related to observability.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/gauge-metrics", "_blank");
      }}
