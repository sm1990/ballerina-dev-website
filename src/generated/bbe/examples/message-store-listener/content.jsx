...
export default function MessageStoreListener({codeSnippets}) {
...
<p>This example demonstrates how to use message store listeners for automated message processing. The <code>StoreListener</code> provides a polling-based mechanism to automatically retrieve and process messages from a message store, with built-in support for retries and dead letter handling.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/message-store-listener", "_blank");
      }}
...
<blockquote>
<p><strong>Tip:</strong> Enable debug logs to see internal logs related to message flow</p>
</blockquote>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run message_store_listener.bal`}</span>
<span>{`
`}</span>
