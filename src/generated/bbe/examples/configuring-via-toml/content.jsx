...
export default function ConfiguringViaToml({codeSnippets}) {
...
<p>For more information, see <a href="/learn/provide-values-to-configurable-variables/#provide-via-toml-syntax/">Configure via TOML syntax</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/configuring-via-toml", "_blank");
      }}
...
<p>To run the example, copy the following content to a file named <code>Config.toml</code> in the current directory.</p>
