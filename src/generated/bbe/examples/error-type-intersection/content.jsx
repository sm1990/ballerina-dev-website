...
export default function ErrorTypeIntersection({codeSnippets}) {
...
<p>If you intersect two <code>error</code> types, the resulting type’s detail type is the intersection of the detail types of both types. Furthermore, if any of the types being intersected is a distinct type, then the resultant type’s type ID set includes all the type IDs of that type. Thus it is a subtype of both types. This way, you can create an error type that is a subtype of multiple distinct types and also use a more specific detail type.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/error-type-intersection", "_blank");
      }}
...
<ul>
<li><a href="https://ballerina.io/learn/by-example/error-subtyping/">Error subtyping</a></li>
</ul>
