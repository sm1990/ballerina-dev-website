...
export default function PersistGetAll({codeSnippets}) {
...
<p>The generated client API provides a <code>get</code> resource method to retrieve all records from the data store.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      className="bg-transparent border-0 m-0 p-2 ms-auto"
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/persist-get-all", "_blank");
      }}
