...
export default function HttpSseClient({codeSnippets}) {
...
<p>The HTTP client supports receiving real-time data from services using server-sent events (SSE). It allows payload-binding of a stream of <code>http:SseEvent</code> when consuming SSE from a service. This payload binding fails if the content type header is not present in the response or does not have the value <code>text/event-stream</code>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/http-sse-client", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>Run the HTTP service given in the <a href="/learn/by-example/http-sse-service/">Server-sent events</a> example.</span>
                        </li>
                    </ul>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run http_sse_client.bal`}</span>
<span>{`
`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/http/#243-client-action-return-types">Client action return types - Specification</a></span>
                        </li>
