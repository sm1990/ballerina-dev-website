...
export const codeSnippetData = [`// This import declaration binds the prefix \`io\` to the \`ballerina/io\` package. 
...
export default function ProgramsAndModules({codeSnippets}) {
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/programs-and-modules", "_blank");
      }}
