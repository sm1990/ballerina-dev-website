...
export default function AiAgentLocalTools({codeSnippets}) {
...
<p>This example demonstrates how to create an AI agent that can manage a to-do list by using local functions as tools, while maintaining a conversation with the user.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/ai-agent-local-tools", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run ai_agent_local_tools.bal`}</span>
