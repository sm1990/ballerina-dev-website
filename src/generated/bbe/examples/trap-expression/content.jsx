...
export default function TrapExpression({codeSnippets}) {
...
<p>If you have an expression such as a function call that can potentially trigger a panic you can use a <code>trap</code> expression to prevent further unwinding of the stack. Then if the evaluation of the expression triggers a panic you will get the <code>error</code> value associated with the panic. Otherwise, you will get the result of the expression.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/trap-expression", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run trap_expression.bal`}</span>
...
<ul>
<li><a href="https://ballerina.io/learn/by-example/panics/">Panics</a></li>
</ul>
