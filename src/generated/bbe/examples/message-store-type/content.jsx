...
export default function MessageStoreType({codeSnippets}) {
...
<p>The <code>messaging</code> package in Ballerina provides messaging capabilities through the <code>Store</code> interface. This example demonstrates how to implement a custom message store by creating your own implementation of the <code>messaging:Store</code> type.</p>


<p>The <code>messaging:Store</code> interface defines the contract for message storage, retrieval, and acknowledgment operations. By implementing this interface, you can create custom message stores that suit your specific requirements while maintaining compatibility with the messaging framework.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/message-store-type", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run message_store_type.bal`}</span>
<span>{`
`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/messaging/latest/"><code>messaging</code> module - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://ballerina.io/spec/messaging/"><code>messaging</code> module - Specification</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/in-memory-message-store/">In-memory message store</a></span>
                        </li>
