...
export default function CheckExpression({codeSnippets}) {
...
<p>If an expression can evaluate to an error value, you can use the <code>check</code> expression to indicate that you want the execution of the current block to terminate with that error as the result. This results in the error value being returned from the current function/worker, unless the <code>check</code> expression is used in a failure-handling statement (e.g., statement with on fail, retry statement).</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/check-expression", "_blank");
      }}
...
<ul>
<li><a href="https://ballerina.io/learn/concurrency/#check-semantics"><code>check</code> semantics</a></li>
</ul>
