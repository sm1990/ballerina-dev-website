...
export default function NamedWorkerWithOnFailClause({codeSnippets}) {
...
<p>The <code>on fail</code> clause can be used with a named worker, to handle any errors that occur within the worker’s body.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/named-worker-with-on-fail-clause", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run named_worker_with_on_fail_clause.bal`}</span>
<span>{`-1`}</span>
</code></pre>
          </Col>
        </Row>
