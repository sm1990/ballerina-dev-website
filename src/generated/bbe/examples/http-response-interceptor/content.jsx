...
export default function HttpResponseInterceptor({codeSnippets}) {
...
<p>The <code>http:ResponseInterceptor</code> is used to intercept the response and execute custom logic. A <code>ResponseInterceptor</code> is a service object with a remote method called <code>interceptResponse</code>, which is executed before dispatching the response to the client. A <code>ResponseInterceptor</code> can be created from a service class, which includes the <code>http:ResponseInterceptor</code> service type.</p>


<p>This service object can be engaged at the service level by declaring an <code>http:InterceptableService</code> object. This accepts an interceptor service object or an array of interceptor service objects as an interceptor pipeline and the interceptors are executed in the order in which they are placed in the pipeline.</p>


<p>Use <code>ResponseInterceptors</code> to execute common logic such as logging, header manipulation, state publishing, etc., for all outbound responses.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/http-response-interceptor", "_blank");
      }}
