...
export default function JsonToRecord({codeSnippets}) {
...
<p>The <code>data.jsondata</code> library provides multiple APIs to perform the conversion from JSON data in the form of a <code>string</code>, <code>byte[]</code>, <code>byte-block-stream</code>, and <code>json</code> to a Ballerina record.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/json-to-record", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run json_to_record.bal`}</span>
