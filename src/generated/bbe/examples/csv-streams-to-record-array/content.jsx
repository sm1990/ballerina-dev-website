...
export default function CsvStreamsToRecordArray({codeSnippets}) {
...
<p>The Ballerina <code>data.csv</code> library allows parsing the CSV byte streams as arrays of Ballerina records, making it easier to process CSV data directly from <code>streams</code>. This functionality supports data projection, enabling developers to extract and map only the required fields to the target <code>record</code> type.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.3/examples/csv-streams-to-record-array", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run csv_streams_to_record_array.bal`}</span>
